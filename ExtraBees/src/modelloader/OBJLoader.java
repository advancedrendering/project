...
//	 //The .obj and .mtl files have to be in the same directory
//	 OBJLoader objLoader = new OBJLoader("model", 1.0f, gl);
...
public class OBJLoader {
	...
	/**
	 * reads the file line by line, ans sets the according fields
	 * 
	 * @param br
